...
class Profile extends MY_Controller {
	...
	public function index(){
		...
		if($this->input->post('submit')){
			...
			$this->load->view('admin/profile/index', $head);
	...
	public function change_password(){
		...
		if($this->input->post('submit')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				redirect(base_url('admin/profile/change_password'),'refresh');
			}
			else{
	...
	public function document(){
		...
		if($this->input->post('submit')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->session->set_flashdata('errors', $data['errors']);
				redirect(base_url('admin/profile/document'),'refresh');
			}
			else{
				...
				if($result){
					$this->session->set_flashdata('success', 'Password has been changed successfully!');
					redirect(base_url('admin/profile/document'));
				}
			}
		}
		else{
			...
			$this->load->view('admin/includes/_header',$data);
			$this->load->view('admin/profile/document', $data);
			$this->load->view('admin/includes/_footer');
		}
	}
}
