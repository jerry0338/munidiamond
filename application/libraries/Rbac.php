...
class RBAC 
{	
	private $hk_module_access;
	function __construct()
	{
		$this->obj =& get_instance();
		$this->obj->module_access = $this->obj->session->userdata('hk_module_access');
	...
	{
		$this->obj->db->from('hk_module_access');
		$this->obj->db->where('department_id',$this->obj->session->userdata('department_id'));
		...
		$this->obj->session->set_userdata('hk_module_access',$data);
