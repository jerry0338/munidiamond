<!-- BEGIN VENDOR CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/css/plugins/calendars/clndr.min.css">
...
<div class="app-content content">
  <div class="content-wrapper">
    ...
    <div class="content-body"><!-- Sales stats -->
              ...
              <div class="card white bg-info text-center">
                  <div class="card-content">
                      <div class="card-body py-3">
                          <img src="<?= base_url()?>assets/images/elements/01.png" alt="element 01" width="140" class="float-left">
      ...
      <div class="row">
          ...
          <div class="col-xl-4 col-md-12 col-sm-12">
              <div class="card border-info text-center bg-transparent">
                  <div class="card-content">
                      <img src="<?= base_url()?>assets/images/elements/07.png" alt="element 04" width="140" class="float-left mt-3">
      ...
      <div class="row">
          <div class="col-lg-4 col-md-12">
              <div class="card">
                  <div class="card-content">
                      <img class="card-img-top img-fluid" src="<?= base_url()?>assets/images/carousel/25.jpg" alt="Card image cap">
                      <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12">
              <div class="card text-center">
                  <div class="card-content">
                      <img class="card-img-top img-fluid" src="<?= base_url()?>assets/images/carousel/24.png" alt="Card image cap">
                      <div class="card-body">
                          <h4>Formal Shoes</h4>
          ...
          <div class="col-lg-4 col-md-12">
              <div class="card">
                  <div class="card-content">
                      <img class="card-img-top img-fluid" src="<?= base_url()?>assets/images/carousel/22.jpg" alt="Card image cap">
                      <div class="card-body">
                          <h4>Sunglass</h4>
                          <p class="card-text">Some quick example text.</p>
                      </div>
    ...
    <script src="<?= base_url()?>assets/vendors/js/extensions/moment.min.js"></script>
    <script src="<?= base_url()?>assets/vendors/js/extensions/underscore-min.js"></script>
    <script src="<?= base_url()?>assets/vendors/js/extensions/clndr.min.js"></script>
    <script src="<?= base_url()?>assets/vendors/js/charts/echarts/echarts.js"></script>
    <script src="<?= base_url()?>assets/vendors/js/extensions/unslider-min.js"></script>

    <script src="<?= base_url()?>assets/js/scripts/pages/dashboard-ecommerce.min.js"></script>